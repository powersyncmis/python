class Shopee:
    home = 'https://ecord.pchome.com.tw/'
    ...
    login_page_url = 'https://ecord.pchome.com.tw/'

    account_input_css_selector = "input[id='s_account']"

    password_input_css_selector = "input[id='s_password']"
